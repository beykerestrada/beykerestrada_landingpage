              ...
              >
                <Card className="p-8">
                  ...
                  <Button asChild variant="outline" className="w-full" size="lg">
                    <Link href="/services/systems-audit">{t("serviceDetail.businessOS.cta.secondary")}</Link>
                  </Button>
                </Card>
              </motion.div>
              ...
              <Card className="p-6 mt-6">
                ...
                <div className="space-y-3">
                  {relatedCaseStudies.map((caseStudy, index) => (
                    <Link key={index} href={caseStudy.link} className="block text-sm text-accent hover:underline">
                      {caseStudy.title}
                    </Link>
                  ))}
                </div>
